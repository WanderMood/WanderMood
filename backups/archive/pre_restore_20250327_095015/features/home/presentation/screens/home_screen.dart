...
class _HomeScreenState extends ConsumerState<HomeScreen> {
  ...
  late final List<Widget> _screens = [
    HomeContent(onGeneratePlan: _generatePlan, selectedMoods: _selectedMoods, onMoodSelected: _handleMoodSelection),
    // const ExploreScreen(),  // TODO: Re-enable when new explore screen is implemented
    const MoodyScreen(),
    const AgendaScreen(),
    const ProfileScreen(),
  ];
...
class HomeContent extends StatefulWidget {
  final Function()? onGeneratePlan;  // Keep the generate plan callback
  final Set<String> selectedMoods;    // Add selected moods from parent
  final Function(String, bool) onMoodSelected;  // Add callback for mood selection
...
class _HomeContentState extends State<HomeContent> {
  ...
  void _handleMoodSelection(String mood) {
    ...
    widget.onMoodSelected(mood, !widget.selectedMoods.contains(mood));
  }

  void _handleGeneratePress() {
    if (widget.selectedMoods.isNotEmpty && widget.onGeneratePlan != null) {
