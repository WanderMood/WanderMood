...
final recommendationServiceProvider = Provider((ref) {
  ...
  return RecommendationService(openAIService: openAIService);
});

final recommendationProvider = StateNotifierProvider<RecommendationNotifier, AsyncValue<List<String>>>((ref) {
  final recommendationService = ref.watch(recommendationServiceProvider);
  return RecommendationNotifier(recommendationService);
});

class RecommendationNotifier extends StateNotifier<AsyncValue<List<String>>> {
