          ...
          Expanded(
            child: MoodSelectionWidget(
              onMoodsSelected: (selectedMoods) {
                // Don't update providers directly in callbacks
                // Instead, use WidgetsBinding to schedule updates after build is complete
                WidgetsBinding.instance.addPostFrameCallback((_) {
                  // Any provider updates should go here
                  // Example: ref.read(preferencesProvider.notifier).updateSelectedMoods(selectedMoods);
