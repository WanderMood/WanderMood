...
class MoodGridWidget extends StatefulWidget {
  ...
  @override
  State<MoodGridWidget> createState() => _MoodGridWidgetState();
}

class _MoodGridWidgetState extends State<MoodGridWidget> with SingleTickerProviderStateMixin {
  ...
  void _handleGeneratePlan() {
    context.go('/moody', extra: {'selectedMoods': _selectedMoods.toList()});
  }
        ...
        if (_selectedMoods.isNotEmpty) ...[
          ...
          Row(
            ...
            children: [
              ...
              Text(
                '${_selectedMoods.length}/3 moods selected',
                style: GoogleFonts.poppins(
                  fontSize: 14,
                  color: Colors.grey[600],
                ),
