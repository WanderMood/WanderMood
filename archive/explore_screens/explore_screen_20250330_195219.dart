                  ...
                  child: Stack(
                    children: [
                      ...
                      if (place.photos?.isNotEmpty ?? false)
                        Image.network(
                          ref.read(explorePlacesProvider(city: currentCity).notifier).getPhotoUrl(place.photos!.first),
                          height: 200,
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Description
                  Text(
                    place.description ?? 'Experience the beauty of ${currentCity}',
                    style: GoogleFonts.poppins(
                      fontSize: 14,
